...
public:
    ...
    Wrapper_7(const char * name){
      ...
      top.trace(&tfp, 99);
      tfp.open((std::string("/home/zqc/桌面/etn5_internship/SpinalWorkshop/./simWorkspace/SimCounterDut_1/") + name + ".vcd").c_str());
      #endif
      this->name = name;
    }
    ...
    virtual ~Wrapper_7(){
      ...
      #endif
      #ifdef COVERAGE
      VerilatedCov::write((("/home/zqc/桌面/etn5_internship/SpinalWorkshop/./simWorkspace/SimCounterDut_1/") + name + ".dat").c_str());
      #endif
    }
