...
public:
    ...
    Wrapper_2(const char * name){
      ...
      top.trace(&tfp, 99);
      tfp.open((std::string("/home/zqc/桌面/etn5_internship/SpinalWorkshop/./simWorkspace/SimStreamJoinForkDut_1/") + name + ".vcd").c_str());
      #endif
      this->name = name;
    }
    ...
    virtual ~Wrapper_2(){
      ...
      #endif
      #ifdef COVERAGE
      VerilatedCov::write((("/home/zqc/桌面/etn5_internship/SpinalWorkshop/./simWorkspace/SimStreamJoinForkDut_1/") + name + ".dat").c_str());
      #endif
    }
