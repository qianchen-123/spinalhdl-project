...
#include "VSimStreamJoinForkDut.h"
#ifdef TRACE
#include "verilated_vcd_c.h"
#endif
#include "VSimStreamJoinForkDut__Syms.h"
...
public:
    ...
    Wrapper_3(const char * name){
      ...
      waveEnabled = true;
      signalAccess[0] = new CDataSignalAccess( top.io_cmdA_valid );
      signalAccess[1] = new CDataSignalAccess( top.io_cmdA_ready );
      signalAccess[2] = new IDataSignalAccess( top.io_cmdA_payload );
      signalAccess[3] = new CDataSignalAccess( top.io_cmdB_valid );
      signalAccess[4] = new CDataSignalAccess( top.io_cmdB_ready );
      signalAccess[5] = new IDataSignalAccess( top.io_cmdB_payload );
      signalAccess[6] = new CDataSignalAccess( top.io_rspMul_valid );
      signalAccess[7] = new CDataSignalAccess( top.io_rspMul_ready );
      signalAccess[8] = new QDataSignalAccess( top.io_rspMul_payload );
      signalAccess[9] = new CDataSignalAccess( top.io_rspXor_valid );
      signalAccess[10] = new CDataSignalAccess( top.io_rspXor_ready );
      signalAccess[11] = new IDataSignalAccess( top.io_rspXor_payload );
      ...
      top.trace(&tfp, 99);
      tfp.open((std::string("/home/zqc/桌面/etn5_internship/SpinalWorkshop/./simWorkspace/SimStreamJoinForkDut_2/") + name + ".vcd").c_str());
      #endif
      this->name = name;
    }
    ...
    virtual ~Wrapper_3(){
      ...
      #endif
      #ifdef COVERAGE
      VerilatedCov::write((("/home/zqc/桌面/etn5_internship/SpinalWorkshop/./simWorkspace/SimStreamJoinForkDut_2/") + name + ".dat").c_str());
      #endif
    }
