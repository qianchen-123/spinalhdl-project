...
public:
    ...
    Wrapper_5(const char * name){
      ...
      waveEnabled = true;
      signalAccess[0] = new CDataSignalAccess( top.io_apb_PSEL );
      signalAccess[1] = new CDataSignalAccess( top.io_apb_PENABLE );
      signalAccess[2] = new CDataSignalAccess( top.io_apb_PWRITE );
      signalAccess[3] = new CDataSignalAccess( top.io_apb_PADDR );
      ...
      top.trace(&tfp, 99);
      tfp.open((std::string("/home/zqc/桌面/etn5_internship/SpinalWorkshop/waves/ApbPwm/") + name + ".vcd").c_str());
      #endif
      this->name = name;
    }
    ...
    virtual ~Wrapper_5(){
      ...
      #endif
      #ifdef COVERAGE
      VerilatedCov::write((("/home/zqc/桌面/etn5_internship/SpinalWorkshop/waves/ApbPwm/") + name + ".dat").c_str());
      #endif
    }
