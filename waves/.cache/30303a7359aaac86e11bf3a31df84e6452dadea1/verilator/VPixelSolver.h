...
VL_MODULE(VPixelSolver) {
  public:
    ...
    // LOCAL VARIABLES
    // Internals; generally not touched by application code
    CData/*3:0*/ __Vdly__PixelSolver__DOT__AddStage_input_payload_iteration;
    CData/*2:0*/ __Vdly__PixelSolver__DOT__AddStage_input_payload_id;
    CData/*0:0*/ __Vclklast__TOP__clk;
    CData/*0:0*/ __Vclklast__TOP__reset;
    IData/*27:0*/ __Vdly__PixelSolver__DOT__AddStage_input_payload_xy;
    IData/*27:0*/ __Vdly__PixelSolver__DOT__Rounter_input_payload_x0;
  ...
  public:
    static void _combo__TOP__6(VPixelSolver__Syms* __restrict vlSymsp);
  private:
  ...
  public:
    ...
    static void _sequent__TOP__2(VPixelSolver__Syms* __restrict vlSymsp);
    static void _sequent__TOP__3(VPixelSolver__Syms* __restrict vlSymsp);
    static void _sequent__TOP__5(VPixelSolver__Syms* __restrict vlSymsp);
    static void _settle__TOP__4(VPixelSolver__Syms* __restrict vlSymsp) VL_ATTR_COLD;
  private:
