...
class Wrapper_18;
thread_local Wrapper_18 *simHandle18;
...
public:
    ...
    Wrapper_18(const char * name){
      ...
      top.trace(&tfp, 99);
      tfp.open((std::string("/home/zqc/桌面/etn5_internship/SpinalWorkshop/waves/Timer/") + name + ".vcd").c_str());
      #endif
      this->name = name;
    }
    ...
    virtual ~Wrapper_18(){
      ...
      #endif
      #ifdef COVERAGE
      VerilatedCov::write((("/home/zqc/桌面/etn5_internship/SpinalWorkshop/waves/Timer/") + name + ".dat").c_str());
      #endif
    }
...
JNIEXPORT Wrapper_18 * API JNICALL Java_wrapper_1verilator_VerilatorNative_newHandle_118
  (JNIEnv * env, jobject obj, jstring name, jint seedValue){
    ...
    Wrapper_18 *handle = new Wrapper_18(ch);
    env->ReleaseStringUTFChars(name, ch);
    return handle;
}

JNIEXPORT jboolean API JNICALL Java_wrapper_1verilator_VerilatorNative_eval_118
  (JNIEnv *, jobject, Wrapper_18 *handle){
   handle->top.eval();
   return Verilated::gotFinish();
}


JNIEXPORT void API JNICALL Java_wrapper_1verilator_VerilatorNative_sleep_118
  (JNIEnv *, jobject, Wrapper_18 *handle, uint64_t cycles){
  #ifdef TRACE
...
JNIEXPORT jlong API JNICALL Java_wrapper_1verilator_VerilatorNative_getU64_118
  (JNIEnv *, jobject, Wrapper_18 *handle, int id){
  return handle->signalAccess[id]->getU64();
}

JNIEXPORT jlong API JNICALL Java_wrapper_1verilator_VerilatorNative_getU64mem_118
  (JNIEnv *, jobject, Wrapper_18 *handle, int id, uint64_t index){
  return handle->signalAccess[id]->getU64_mem(index);
}

JNIEXPORT void API JNICALL Java_wrapper_1verilator_VerilatorNative_setU64_118
  (JNIEnv *, jobject, Wrapper_18 *handle, int id, uint64_t value){
  handle->signalAccess[id]->setU64(value);
}

JNIEXPORT void API JNICALL Java_wrapper_1verilator_VerilatorNative_setU64mem_118
  (JNIEnv *, jobject, Wrapper_18 *handle, int id, uint64_t value, uint64_t index){
  handle->signalAccess[id]->setU64_mem(value, index);
}

JNIEXPORT void API JNICALL Java_wrapper_1verilator_VerilatorNative_deleteHandle_118
  (JNIEnv *, jobject, Wrapper_18 * handle){
  delete handle;
}

JNIEXPORT void API JNICALL Java_wrapper_1verilator_VerilatorNative_getAU8_118
  (JNIEnv * env, jobject obj, Wrapper_18 * handle, jint id, jbyteArray value){
  handle->signalAccess[id]->getAU8(env, value);
}

JNIEXPORT void API JNICALL Java_wrapper_1verilator_VerilatorNative_getAU8mem_118
  (JNIEnv * env, jobject obj, Wrapper_18 * handle, jint id, jbyteArray value, uint64_t index){
  handle->signalAccess[id]->getAU8_mem(env, value, index);
}

JNIEXPORT void API JNICALL Java_wrapper_1verilator_VerilatorNative_setAU8_118
  (JNIEnv * env, jobject obj, Wrapper_18 * handle, jint id, jbyteArray value, jint length){
  handle->signalAccess[id]->setAU8(env, value, length);
}

JNIEXPORT void API JNICALL Java_wrapper_1verilator_VerilatorNative_setAU8mem_118
  (JNIEnv * env, jobject obj, Wrapper_18 * handle, jint id, jbyteArray value, jint length, uint64_t index){
  handle->signalAccess[id]->setAU8_mem(env, value, length, index);
}

JNIEXPORT void API JNICALL Java_wrapper_1verilator_VerilatorNative_enableWave_118
  (JNIEnv *, jobject, Wrapper_18 * handle){
  handle->waveEnabled = true;
}

JNIEXPORT void API JNICALL Java_wrapper_1verilator_VerilatorNative_disableWave_118
  (JNIEnv *, jobject, Wrapper_18 * handle){
